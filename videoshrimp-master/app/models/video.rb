class Video < ActiveRecord::Base
  # establish_connection(:adapter => "sqlite3" , :database  => "#{Rails.root}db/development_1.sqlite3")
  ...
  #   true #self.webm_file.path && self.mp4_file.path && self.ogg_file.path ? true : false
  # end
